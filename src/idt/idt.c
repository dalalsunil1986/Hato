...
void idt_initializating(void)
{
    ...
    IDT[32].offset_lowerbits = irq0_adress & 0xffff;
    ...
    IDT[33].offset_lowerbits = irq1_adress & 0xffff;
    ...
    IDT[34].offset_lowerbits = irq2_adress & 0xffff;
    ...
    IDT[35].offset_lowerbits = irq3_adress & 0xffff;
    ...
    IDT[36].offset_lowerbits = irq4_adress & 0xffff;
    ...
    IDT[37].offset_lowerbits = irq5_adress & 0xffff;
    ...
    IDT[38].offset_lowerbits = irq6_adress & 0xffff;
    ...
    IDT[39].offset_lowerbits = irq7_adress & 0xffff;
    ...
    IDT[40].offset_lowerbits = irq8_adress & 0xffff;
    ...
    IDT[41].offset_lowerbits = irq9_adress & 0xffff;
    ...
    IDT[42].offset_lowerbits = irq10_adress & 0xffff;
    ...
    IDT[43].offset_lowerbits = irq11_adress & 0xffff;
    ...
    IDT[44].offset_lowerbits = irq12_adress & 0xffff;
    ...
    IDT[45].offset_lowerbits = irq13_adress & 0xffff;
    ...
    IDT[46].offset_lowerbits = irq14_adress & 0xffff;
    ...
    IDT[47].offset_lowerbits = irq15_adress & 0xffff;
    ...
    idt_adress = (unsigned long)IDT;
    idt_ptr[0] = (sizeof (struct IDT_entry) * 256) + ((idt_adress & 0xffff) << 16);
